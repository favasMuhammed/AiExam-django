    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'Email already used'}, max_length=255, unique=True)),
                ('is_manager', models.BooleanField(default=False, verbose_name='Is manager')),
                ('is_institute', models.BooleanField(default=False, verbose_name='Is institute')),
